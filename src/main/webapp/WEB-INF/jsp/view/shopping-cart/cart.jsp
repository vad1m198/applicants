...
<div class="slds">
    ...
    <div class="slds-text-heading--small slds-m-around--medium">Shopping Cart Page</div>
   ...
   <c:if test="${not empty cartForm and not empty cartForm.cartLines}">   	
    ...
    <form:form method="POST" modelAttribute="cartForm">
       ...
       <div class="slds-button-group slds-m-left--medium" role="group">
           ...
           <a class="slds-button slds-button--neutral" href="<c:url value="/shopping-cart/customer" />">Place Order</a>
       </div>
   </form:form>
   </c:if>
</div>
